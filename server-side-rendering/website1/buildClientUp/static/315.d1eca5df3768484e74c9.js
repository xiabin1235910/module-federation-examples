"use strict";
(self["__LOADABLE_LOADED_CHUNKS__"] = self["__LOADABLE_LOADED_CHUNKS__"] || []).push([[315],{
...
// EXTERNAL MODULE: consume shared module (default) react@>=16.3.0 (strict) (fallback: ./node_modules/react/index.js)
var index_js_ = __webpack_require__(9947);
...
// UNUSED EXPORTS: HashRouter, MemoryRouter, NavLink, Navigate, Outlet, Route, Router, Routes, UNSAFE_LocationContext, UNSAFE_NavigationContext, UNSAFE_RouteContext, createRoutesFromChildren, createSearchParams, generatePath, matchPath, matchRoutes, renderMatches, resolvePath, unstable_HistoryRouter, useHref, useInRouterContext, useLinkClickHandler, useLocation, useMatch, useNavigate, useNavigationType, useOutlet, useOutletContext, useParams, useResolvedPath, useRoutes, useSearchParams

// EXTERNAL MODULE: consume shared module (default) react@>=16.8 (strict) (fallback: ./node_modules/react/index.js)
var index_js_ = __webpack_require__(1817);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
var esm_extends = __webpack_require__(2122);
;// CONCATENATED MODULE: ./node_modules/react-router-dom/node_modules/history/index.js
...
function createBrowserHistory(b){function h(){var c=p.location,a=m.state||{};return[a.idx,C({pathname:c.pathname,search:c.search,hash:c.hash,state:a.usr||null,key:a.key||"default"})]}function e(c){return"string"===typeof c?c:I(c)}function x(c,a){void 0===a&&(a=null);return C((0,esm_extends/* default */.Z)({pathname:q.pathname,hash:"",search:""},"string"===typeof c?J(c):c,{state:a,key:H()}))}function z(c){t=c;c=h();v=c[0];q=c[1];d.call({action:t,location:q})}function A(c,a){function f(){A(c,a)}var l=r.Push,k=x(c,
...
var react_router = __webpack_require__(1740);
...
function BrowserRouter(_ref) {
  ...
  return /*#__PURE__*/(0,index_js_.createElement)(react_router/* Router */.F0, {
    basename: basename,
    children: children,
...
const Link = /*#__PURE__*/(0,index_js_.forwardRef)(function LinkWithRef(_ref4, ref) {
  ...
  let href = (0,react_router/* useHref */.oQ)(to);
...
function useLinkClickHandler(to, _temp) {
  ...
  let navigate = (0,react_router/* useNavigate */.s0)();
  let location = (0,react_router/* useLocation */.TH)();
  let path = (0,react_router/* useResolvedPath */.WU)(to);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "WU": () => (/* binding */ useResolvedPath)
});

// UNUSED EXPORTS: MemoryRouter, Navigate, Outlet, UNSAFE_LocationContext, UNSAFE_NavigationContext, UNSAFE_RouteContext, createRoutesFromChildren, generatePath, matchPath, matchRoutes, renderMatches, resolvePath, useInRouterContext, useMatch, useNavigationType, useOutlet, useOutletContext, useParams, useRoutes
...
function _renderMatches(matches, parentMatches) {
  ...
  return matches.reduceRight((outlet, match, index) => {
    return /*#__PURE__*/(0,index_js_.createElement)(RouteContext.Provider, {
      children: match.route.element !== undefined ? match.route.element : /*#__PURE__*/(0,index_js_.createElement)(Outlet, null),
      value: {
        outlet,
...
//# sourceMappingURL=315.d1eca5df3768484e74c9.js.map